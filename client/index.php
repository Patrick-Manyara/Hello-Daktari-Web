                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                ...
                                if (!empty($session_today)) { ?>
                                    You have a session today with <span class="fw-bold"><?= $session_today['doctor_name'] ?></span> at
                            ...
                            foreach ($past_sessions as $past) { ?>
                                <li class="timeline-item timeline-item-transparent">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <p class="mb-2">With: <?= $past['doctor_name'] ?></p>
                                        <p class="mb-2">Mode: <?= ucwords($past['session_mode']) ?></p>
                                        <p class="mb-2">From: <?= $past['session_start_time'] ?> . To: <?= $past['session_end_time'] ?></p>
                                        <a href="../rebook?tid=<?= encrypt($past['doctor_id']) ?>" class="btn rounded-pill btn-outline-primary">
                                            <span class="tf-icons bx bx-pie-chart-alt me-1"></span>Book Session With Same doctor
                                        </a>
                                    </div>
                                </li>
                            <?php
                            ...
                            foreach ($next_sessions as $next) { ?>
                                <li class="timeline-item timeline-item-transparent">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <p class="mb-2">With: <?= $next['doctor_name'] ?></p>
