<?php
$page = 'applied_doctors';
require_once '../path.php';
include_once 'header.php';
$doctors = get_all_doctors('deactivated');
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="../model/approve?id=<?= $doctor_id ?>&table=<?= encrypt('doctor') ?>&page=<?= encrypt('view_doctors') ?>" class="btn btn-info">
                                    Approve
                                </a>
                            </td>
                        </tr>
