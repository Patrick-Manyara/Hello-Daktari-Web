...
$orders = select_rows("SELECT * FROM cart GROUP BY cart_code ORDER BY cart_date_created DESC");
            ...
            <table class="datatables-basic table border-top">
                ...
                <tbody>
                    ...
                    foreach ($orders as $order) {
                        ...
                        $sql = "SELECT cart_code, SUM(cart_price) AS total_cart_price FROM cart WHERE cart_code = '$order[cart_code]' GROUP BY cart_code ";
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= 'Ksh. ' . $price ?></td>  
                            <td>
                                <a href="shop_items?id=<?= encrypt($order['cart_code']) ?>" class="btn btn-primary">
                                    View
                                </a>
                            </td>
