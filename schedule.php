...
$doctors = get_by_id('doctor', security('id','GET'));
...
foreach ($doctors as $doctor) {
    ...
    $sql = "select * from session where doctor_id = '$doctor[doctor_id]' AND session_payment_status = 'paid' ";
    $dt = select_rows($sql);
...
?>
    <div class="cnt">
        ...
        <form method="post" action="packages" id="proceed<?= $doctor['bookmark_id'] ?>" style="display:none">
